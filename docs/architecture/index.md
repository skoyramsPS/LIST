...
`/docs/planning/active/PRD.md`. It is archived to `/_human/` once the product is
built.)
...
| Product behaviour, feature scope, what a screen should do | [`/docs/planning/active/PRD.md`](../planning/active/PRD.md) | — |
